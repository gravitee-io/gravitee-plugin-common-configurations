...
public interface TrustStoreMapper {
    ...
    default io.gravitee.node.vertx.client.ssl.TrustStore map(TrustStore trustStore) {
        ...
        return switch (TrustStoreImplementation.get(trustStore.getClass().getName())) {
    ...
    enum TrustStoreImplementation {
        ...
        static {
            Map<String, TrustStoreImplementation> map = new ConcurrentHashMap<String, TrustStoreImplementation>();
